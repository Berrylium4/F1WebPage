...
?>
		<h3 id="title"> 2017 F1 Constructor Standings </h3>
	
<?php
		$sql = "SELECT constructor_name, score, principal_name \n"
		...
		if ($result->num_rows > 0){
			...
			while ($row = $result->fetch_assoc()){
				echo "<tr><td>" . strval($counter++) . "</td><td>" . $row["constructor_name"] . "</td><td>" . $row["score"] 
				. "</td><td>" . $row["principal_name"] . "</td></tr>";
			}
