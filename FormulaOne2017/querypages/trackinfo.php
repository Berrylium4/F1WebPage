...
?>
		<h3 id="title"> 2017 F1 Track Information </h3>
	
<?php
		$sql = "SELECT tname, country, city, tlength\n"
		...
		if ($result->num_rows > 0){
			...
			while ($row = $result->fetch_assoc()){
				echo "<tr><td>" . $row["tname"] . "</td><td>" . $row["country"] 
				. "</td><td>" . $row["city"] . "</td><td>" . $row["tlength"] . "</td></tr>";
			}
